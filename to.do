(PROBLEMS:
 (what if donors spam the system with fake requests for stuff
...
(USE CASES / USER STORIES:
 (Someone is passing by a homeless person in great need who
  doesn't have a phone.  They enter the information into the
